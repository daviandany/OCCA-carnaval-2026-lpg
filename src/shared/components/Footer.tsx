        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-16 mb-20">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-xl leading-loose text-black max-w-2xl">
              No meio do sobe e desce das ladeiras de Olinda, OCCA vira casa pra
              quem vive o Carnaval intensamente. Um casarão histórico onde
              frevo, criatividade e descanso coexistem. Tudo a poucos passos da
              folia.
            </p>
          </div>
          ...
          {/* Localização */}
          <div>
            <h4 className="bg-black text-occaYellow px-3 py-1 text-xs font-bold uppercase tracking-widest mb-6">
              Onde fica a folia
            </h4>
            <p className="text-lg text-black font-medium flex flex-wrap gap-1">
              <span>Rua Manoel Borba, 285, Carmo</span>
              <span>·</span>
              <span>Sítio Histórico de Olinda / PE</span>
              <span>·</span>
              <span>Epicentro do Carnaval</span>
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-lg font-bold uppercase tracking-tight text-black">
              <li>
                <a
                  href="#quartos"
                  className="hover:text-occaRed transition-colors"
                >
                  Quartos
                </a>
              </li>
